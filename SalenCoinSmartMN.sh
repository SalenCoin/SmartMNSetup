...
COINGITHUB=https://github.com/SalenCoin/Salen-Project.git
SENTINELGITHUB=https://github.com/SalenCoin/Sentiel.git
COINSRCDIR=SalenCoinSRC
...
echo
echo -e "${BLUE}                                                                 MMMMMMM        ${NONE}"
echo -e "${BLUE}                                                               MMMMMMMMMMM      ${NONE}"
echo -e "${BLUE}                                  MMM                         MMMMM    MMMM     ${NONE}"
echo -e "${BLUE}                              MMMMMMMMMMM                     MMM       MMM     ${NONE}"
echo -e "${BLUE}                            MMMMMMMMMMMMMM                 MMMMMM       MMM     ${NONE}"
echo -e "${BLUE}                           MMMMM       MMMM        MMMMMM   MMMMM       MMM     ${NONE}"
echo -e "${BLUE}                           MMM           MMMMMMMM  MMMMMM      MMMM    MMMM     ${NONE}"
echo -e "${BLUE}                          MMM            MMMMMMMM   M          MMMMMMMMMMM      ${NONE}"
echo -e "${BLUE}                          MMM             MMMMM                  MMMMMMMM       ${NONE}"
echo -e "${BLUE}     MMMMMMMMM            MMM  MM         MMM                                   ${NONE}"
echo -e "${BLUE}    MMMMM  MMMM           MMMMMMMMMM     MMMM                                   ${NONE}"
echo -e "${BLUE}   MMM        MM           MMM   MMMM   MMMM                                    ${NONE}"
echo -e "${BLUE}  MMM          MM         MMMMMM   MMM MMMM                                     ${NONE}"
echo -e "${BLUE}  MM           MMMMM  MMMMMMMMMMMMMMMMMMMMMM                                    ${NONE}"
echo -e "${BLUE}  MM           MMMMMM MMMMMM  MMMMMMMMMMM MMMM                                  ${NONE}"
echo -e "${BLUE}  MM           MM          MM     MMM      MMMM                                 ${NONE}"
echo -e "${BLUE}   MMM       MMM           MMMMMMMMM        MMM                                 ${NONE}"
echo -e "${BLUE}    MMMMMMMMMMM             MMMMMMM             MM                              ${NONE}"
echo -e "${BLUE}     MMMMMMMMM             MM                  MMMM       MMM                   ${NONE}"
echo -e "${BLUE}                          M                     MMMMMMMMMMMMMMMMM               ${NONE}"
echo -e "${BLUE}                         MMM                      MMMMMMMMMMMMMMMMM             ${NONE}"
echo -e "${BLUE}                         MM                       MMMMMM       MMMMMM           ${NONE}"
echo -e "${BLUE}                                                 MMMM            MMMMM          ${NONE}"
echo -e "${BLUE}                   MMMMMM                       MMMM               MMM          ${NONE}"
echo -e "${BLUE}                  MMMMMMM                       MMM                 MMM         ${NONE}"
echo -e "${BLUE}                 MM    MMM                     MMM                  MMM         ${NONE}"
echo -e "${BLUE}                 MM     MM                     MMM                  MMMM        ${NONE}"
echo -e "${BLUE}                  MMMMMMM                      MMM                  MMMM        ${NONE}"
echo -e "${BLUE}                   MMMMM                        MMM                 MMM         ${NONE}"
echo -e "${BLUE}                                                MMM                MMMM         ${NONE}"
echo -e "${BLUE}                                                 MMM               MMM          ${NONE}"
echo -e "${BLUE}                                                 MMMMM           MMMMM          ${NONE}"
echo -e "${BLUE}                                                  MMMMMMM     MMMMMM            ${NONE}"
echo -e "${BLUE}                                                    MMMMMMMMMMMMMMM             ${NONE}"
echo -e "${BLUE}                                                      MMMMMMMMMM                ${NONE}"


echo -e "${BOLD}"
read -p "This script will setup your Salen Coin Masternode. Do you wish to continue? (y/n)?" response
echo -e "${NONE}"
